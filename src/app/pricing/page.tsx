...
<div className="flex flex-col gap-20">
      {/* TOGGLE BUTTON */}
      <div className="relative flex flex-row items-center justify-center gap-2 w-full max-w-md mx-auto  px-4">
        {/* Monthly Label */}
      ...
      {/* THREE DIVS */}
<div>
      <div className=" ml-40 w-[985px] h[704px] lg:flex lg:flex-row flex-col gap-[20px]">
        {/* one */}
